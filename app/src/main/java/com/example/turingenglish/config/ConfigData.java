package com.example.turingenglish.config;
...
public class ConfigData {
    ...
    public static boolean getIsFirst() {
        SharedPreferences preferences = MyApplication.context.getSharedPreferences(SharedDataName, Context.MODE_PRIVATE);
    ...
    public static void setIsFirst(boolean isFirst) {
        SharedPreferences.Editor editor = MyApplication.context.getSharedPreferences(SharedDataName, Context.MODE_PRIVATE).edit();
